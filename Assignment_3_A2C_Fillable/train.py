...
def train_actor_critic(config_path=None, plot=True):
    ...
    for i_episode in range(config["num_episodes"]):
        ...
        # TODO: Decide whether a bootstrap value is needed
        # Hint: If the episode stopped because of a time limit rather than a true terminal
        # condition, the critic can provide an estimate for what comes next.
